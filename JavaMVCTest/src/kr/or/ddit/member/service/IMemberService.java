 ...
 * 결과를 받아오고, 받아온 자료를 Controller에게 보내주는 역할을 
 * 수행한다. 보통 DAO의 메소드와 같은 구조를 갖는다.
 * @author user
 *
 */
public interface IMemberService {
	...
	/**
	 * MemberVO에 담긴 데이터를 DB에 insert 하는 메소드
	...
	/**
	 * 하나의 MemberVO 데이터를 이용하여 회원정보를 업데이트하는 메소드
	...
	/**
	 * 회원ID를 매개변수로 받아서 그 회원 정보를 삭제하는 메소드
	 ...
	 */
	public List<MemberVO> serchMember(MemberVO mv);
